...
In this coding test assignment we have prepared a hiring system where job seekers (candidates) can be found and get contacted and hired from companies' hiring managers.

The system is free for job seekers, but not for companies.
...
_**This app was created only for the purpose of the test assignment and code quality in this repository DOES NOT represent code quality in BinaryFusion.**_
